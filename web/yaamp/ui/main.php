...
function showPageFooter()
{
	...
	echo "<p>&copy; $year ".YAAMP_SITE_NAME.' - '.
		'<a href="/site/about">About Us</a> - <a href="/site/faq">FAQ</a> - <a href="/site/contact">Contact</a> - <a href="/site/linminingc">Mining Contract</a> - <a target="_blank" href="http://github.com/tpruvot/yiimp">Yiimp</a></p>';
