...
define('YAAMP_DBNAME', 'dbname');
define('YAAMP_DBUSER', 'dbuser');
define('YAAMP_DBPASSWORD', 'password');
define('YAAMP_PRODUCTION', true);
define('YAAMP_RENTAL', false);
define('YAAMP_LIMIT_ESTIMATE', false);
define('YAAMP_FEES_MINING', 2.5);
define('YAAMP_FEES_EXCHANGE', 2);
define('YAAMP_FEES_RENTING', 2);
define('YAAMP_TXFEE_RENTING_WD', 0.002);
define('YAAMP_PAYMENTS_FREQ', 12*60*60);
define('YAAMP_PAYMENTS_MINI', 0.05);
define('YAAMP_ALLOW_EXCHANGE', true);
define('YIIMP_PUBLIC_EXPLORER', true);
define('YIIMP_PUBLIC_BENCHMARK', true);
define('YIIMP_FIAT_ALTERNATIVE', 'USD'); // USD is main
define('YAAMP_USE_NICEHASH_API', false);
define('YAAMP_BTCADDRESS', '1N5gjkjbRMZhjQcYp61jEFHEhKGatYXM19');
define('YAAMP_SITE_URL', 'linpool.com');
define('YAAMP_STRATUM_URL', YAAMP_SITE_URL); // change if your stratum server is on a different host
define('YAAMP_SITE_NAME', 'LinPool');
define('YAAMP_ADMIN_EMAIL', 'linpool@gmail.com');
